...
public class QComputer extends EntityPathBase<Computer> {
    ...
    private static final long serialVersionUID = 59771374L;
    ...
    public final DateTimePath<java.time.LocalDateTime> discontinuedDate = createDateTime("discontinuedDate", java.time.LocalDateTime.class);

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final DateTimePath<java.time.LocalDateTime> introducedDate = createDateTime("introducedDate", java.time.LocalDateTime.class);
